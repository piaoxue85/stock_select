    ...
    def update_figure(self):
        ...
        for i in range(5,self.num):
            ...
            if condition1 and condition2 and condition3 and condition4 and condition5:
                self.ax1.annotate('E', xy=(i, low_6), xytext=(i, low_6-0.5), arrowprops=dict(arrowstyle="->"))
            if condition1 and condition2 and condition3 and condition4 and condition6:
                self.ax1.annotate('E', xy=(i, high_6), xytext=(i, high_6+0.5), arrowprops=dict(arrowstyle="->"))
            deviate_1 = deviate_2
            deviate_2 = deviate_3
            deviate_3 = deviate_4
            deviate_4 = deviate_5
